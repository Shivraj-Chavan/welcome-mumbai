          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            <div className="hidden sm:flex items-center space-x-2 text-gray-700 hover:text-orange-600 transition-colors group">
              ...
              <div className="hidden lg:block">
                ...
                <div className="text-sm font-medium">hello@majhimumbai.com</div>
              </div>
            </div>
            
            {/* Phone */}
            <div className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition-colors group">
            ...
            <div className="sm:hidden flex items-center space-x-2">
              <a href="mailto:hello@majhimumbai.com" className="p-2 bg-orange-50 rounded-full hover:bg-orange-100 transition-colors">
                <Mail className="w-4 h-4 text-orange-600" />
              </a>
              <a href="tel:+919876543210" className="p-2 bg-blue-50 rounded-full hover:bg-blue-100 transition-colors">
                <Phone className="w-4 h-4 text-blue-600" />
              </a>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>hello@majhimumbai.com</span>
                </div>
                <div className="flex items-center space-x-2">
